...
# install screenfetch
cd
wget 'https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/screenfetch-dev'
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>www.sshanaksolo.info</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/vps.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/badvpn/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/badvpn/badvpn-udpgw64"
fi
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/dropbear-2014.63.tar.bz2
...
wget https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/vnstat_php_frontend-1.5.1.tar.gz
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/squid3.conf"
...
# download script
cd
wget -O speedtest_cli.py "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/speedtest_cli.py"
wget -O bench-network.sh "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/bench-network.sh"
wget -O ps_mem.py "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/ps_mem.py"
wget -O dropmon "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/dropmon.sh"
wget -O user-login.sh "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/user-login.sh"
wget -O user-expired.sh "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/user-expired.sh"
#wget -O userlimit.sh "https://raw.githubusercontent.com/suryadewa/fornesiavps/fns/limit.sh"
wget -O user-list.sh "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/user-list.sh"
wget -O /etc/issue.net "https://raw.githubusercontent.com/SSHAnakSolo/autoscript/master/null/banner"
...
echo "Squid3    : 80, 8000, 8080, 3128 (limit to IP SSH)"  | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "Auto Script Installer VPS - www.sshanaksolo.info"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
